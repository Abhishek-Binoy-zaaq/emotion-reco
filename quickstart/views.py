    ...
    if request.method == 'POST':
        ...
        if user is not None:
            if not user.is_active:
                return render(request, 'quickstart/login.html', {'error': 'Your account has been disabled. Please contact admin.'})
            login(request, user)
            if user.is_staff:
                return redirect('admin_dashboard')
            return redirect('user_dashboard')
        else:
            return render(request, 'quickstart/login.html', {'error': 'Invalid credentials'})
    
    return render(request, 'quickstart/login.html')
...
def admin_dashboard(request):
    """Admin dashboard"""
    return render(request, 'quickstart/admin_dashboard.html')
...
def admin_videos(request):
    ...
    return render(request, 'quickstart/admin_videos.html')
...
def admin_users(request):
    ...
    return render(request, 'quickstart/admin_users.html')
...
def admin_reports(request):
    ...
    return render(request, 'quickstart/admin_reports.html')
...
def admin_video_report(request, video_id):
    ...
    return render(request, 'quickstart/admin_video_report.html', {'video_id': video_id})
...
def user_dashboard(request):
    ...
    return render(request, 'quickstart/user_dashboard.html')


@login_required
def user_sessions(request):
    """User's previous sessions"""
    return render(request, 'quickstart/user_sessions.html')


@login_required
def user_session(request, video_id):
    """User video session"""
    return render(request, 'quickstart/user_session.html', {'video_id': video_id})


@login_required
def user_report(request, session_id):
    """User session report"""
    return render(request, 'quickstart/user_report.html', {'session_id': session_id})
