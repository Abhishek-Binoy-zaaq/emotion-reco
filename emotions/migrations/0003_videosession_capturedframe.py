...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('emotions', '0002_uploadedimage_all_expressions_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='captures', to='emotions.videosession')),
            ],
            options={
                'ordering': ['timestamp'],
            },
