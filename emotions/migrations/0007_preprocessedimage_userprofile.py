...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('emotions', '0006_videocategory_video_category'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='preprocessed_version', to='emotions.capturedframe')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
